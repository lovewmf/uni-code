(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var getEncoding = function (character) {
        return getBinary(characterValue(character));
    };
    var getBinary = function (characterValue) {
        return encodings[characterValue].toString(2);
    };
    var characterValue = function (character) {
        return characters.indexOf(character);
    };

    var BarCode128 = StringToCode128;
    var BarCode39 = CODE39;
    ...
    var SetBarCodeType = {
        ...
        "CODE39": function CODE39(code, gc, height) {
            var Code39 = new BarCode39(code);
            var binary = Code39.encode();
            console.log(binary);
        },
